...
<section id="cta2" class="red-background">
    <div class="container">
        <div class="text-center">
            <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"> PELAYANAN SURAT KETERANGAN <br>
                KELURAHAN WAKANDA</h2>
            <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">KLIK LOGIN UNTUK REQUEST PEMBUATAN
                SURAT KETERANGAN
            ...
            <img class="img-responsive wow fadeIn" src="main/images/cta2/cta2-img.png" alt=""
                    ...
                    <div class="media service-box">
                        ...
                        <div class="media-body">
                            ...
                            <p>Setelah input data pemohon dengan lengkap dan benar, Pemohon memilih Surat yang mau
                                direquest serta melengkapi data request, Kemudian Dikirim dan Menunggu persetujuan dari
                                Lurah.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                    <div class="media service-box">
                        ...
                        <div class="media-body">
                            ...
                            <p>Permohonan di setujui oleh lurah, kemudian staf akan mencetak surat sesuai request surat
                                yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor
                                Kelurahan Wakanda.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ul class="social-icons">
                    <li><a href="https://www.instagram.com/kelurahan/" target="_blank"><i
